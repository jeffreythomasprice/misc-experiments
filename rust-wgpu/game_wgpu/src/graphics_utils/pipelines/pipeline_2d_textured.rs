...
use crate::{
    graphics_utils::basic_types::{HasVertexBufferLayout, Vertex2DTextureCoordinateRGBA},
    wgpu_utils::{
        mesh::Mesh,
...
impl<'a> Renderer<'a> {
    pub fn render(
        ...
        mesh: &Mesh<Vertex2DTextureCoordinateRGBA>,
    ) {
        self.render_pass
...
impl Pipeline2DTextured {
    pub const SCENE_UNIFORM_BINDING: u32 = 0;
    pub const MODEL_UNIFORM_BINDING: u32 = 0;
    pub const TEXTURE_BINDING: u32 = 0;
    pub const TEXTURE_SAMPLER_BINDING: u32 = 1;
    ...
    pub fn new(
        ...
        let render_pipeline = device.create_render_pipeline(&RenderPipelineDescriptor {
            ...
            vertex: VertexState {
                ...
                buffers: &[Vertex2DTextureCoordinateRGBA::vertex_buffer_layout()],
            },
