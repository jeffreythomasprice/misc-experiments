...
public readonly struct Vertex3DTexturedRgba(
...
) : IBufferBindable
{
    ...
    public readonly Vector3D<float> Position = position;
    ...
    public static VertexInputBindingDescription BindingDescription =>
        ...
        {
            Binding = 0,
            Stride = (uint)Unsafe.SizeOf<Vertex3DTexturedRgba>(),
    ...
    public static VertexInputAttributeDescription[] AttributeDescriptions =>
        [
            new()
            {
                ...
                Offset = (uint)Marshal.OffsetOf<Vertex3DTexturedRgba>(nameof(Position)),
            },
            new()
            {
                Binding = 0,
                ...
                Offset = (uint)Marshal.OffsetOf<Vertex3DTexturedRgba>(nameof(TextureCoordinate)),
            },
            new()
            {
                Binding = 0,
                ...
                Offset = (uint)Marshal.OffsetOf<Vertex3DTexturedRgba>(nameof(Color)),
            },
        ];
}
