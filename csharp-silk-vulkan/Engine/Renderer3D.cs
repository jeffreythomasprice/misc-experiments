...
using VertexType = Vertex3DTexturedRgba;

public sealed class Renderer3D : RendererBase<VertexType>
{
    public Renderer3D(
        Vk vk,
        Shaderc shaderc,
    ...
    protected override string VertexShaderSource =>
        $$"""
            ...
            layout(location = {{VertexType.POSITION_LOCATION}}) in vec3 inPosition;
